...
export default function (context) {
  console.log("Checking if MongoDB connection string exists...");
  if(connection && connection.connection) { //Basically if file does not exist this should fail silently
    console.log("    Exists. Attempting to reach server...");    
    ...
    db.once('open', function() {
      console.log("    MongoDB instance opened.");    
      Users = usersModel();
        //
